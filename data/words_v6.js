// KET A2 Key for Schools - Vocabulary Data v5
// 150 words (15 days x 10) + 75 exam-style questions (15 days x 5)
...
// KET Exam-Style Vocabulary Questions
// Part 4 style: choose the correct word (multiple choice)
// Part 5 style: fill in the blank with the first letter given
// 15 days x 5 questions = 75 questions total

const KET_WORD_QUESTIONS = [
  // Day 1
  {
    day: 1,
    title: "Day 1 词汇真题",
    questions: [
      { type: "choose", q: "We arrived ____ the airport at six o'clock in the morning.", options: ["in", "at", "on", "to"], answer: 1 },
      { type: "choose", q: "This film is very ____. I want to sleep.", options: ["interesting", "dangerous", "boring", "expensive"], answer: 2 },
      { type: "fill", q: "Don't forget to bring your c____. We need to take photos. (相机)", answer: "camera" },
      { type: "fill", q: "This shirt is very c____. It only costs ten yuan. (便宜的)", answer: "cheap" },
      { type: "choose", q: "We always ____ New Year with our family.", options: ["celebrate", "remember", "decide", "practice"], answer: 0 },
    ]
  },
  ...
  // Day 2
  {
    ...
    title: "Day 2 词汇真题",
    questions: [
      { type: "choose", q: "I can't ____ this question. It is too difficult.", options: ["answer", "decide", "invite", "celebrate"], answer: 0 },
      { type: "fill", q: "The food at this restaurant is very d____. (美味的)", answer: "delicious" },
      { type: "fill", q: "If you don't know a word, look it up in a d____. (词典)", answer: "dictionary" },
      { type: "choose", q: "This watch is very ____. It costs 10,000 yuan.", options: ["cheap", "expensive", "comfortable", "boring"], answer: 1 },
      { type: "choose", q: "The shop assistant was very ____ and helped me find what I needed.", options: ["friendly", "foreign", "difficult", "handsome"], answer: 0 },
    ]
  },
  ...
  // Day 3
  {
    ...
    title: "Day 3 词汇真题",
    questions: [
      { type: "fill", q: "My h____ is reading books. I read every evening. (爱好)", answer: "hobby" },
      { type: "choose", q: "We are going on ____ to Hainan this summer.", options: ["holiday", "language", "homework", "journey"], answer: 0 },
      { type: "choose", q: "It is very ____ to drink water every day.", options: ["interesting", "important", "lonely", "lovely"], answer: 1 },
      { type: "fill", q: "I want to i____ you to my birthday party. (邀请)", answer: "invite" },
      { type: "choose", q: "English is an international ____. People speak it all over the world.", options: ["letter", "journey", "language", "knowledge"], answer: 2 },
    ]
  },
  ...
  // Day 4
  {
    ...
    title: "Day 4 词汇真题",
    questions: [
      { type: "fill", q: "I go to the l____ to borrow books every week. (图书馆)", answer: "library" },
      { type: "choose", q: "What a ____ day! The sun is shining and the birds are singing.", options: ["lonely", "lucky", "lovely", "boring"], answer: 2 },
      { type: "choose", q: "My father buys fresh fruit and vegetables at the ____.", options: ["library", "market", "mountain", "meeting"], answer: 1 },
      { type: "fill", q: "Take this m____ three times a day after meals. (药)", answer: "medicine" },
      { type: "choose", q: "I'm sorry, I made a ____ in my spelling test.", options: ["mistake", "magazine", "meeting", "mountain"], answer: 0 },
    ]
  },
  ...
  // Day 5
  {
    ...
    title: "Day 5 词汇真题",
    questions: [
      { type: "choose", q: "We visited the science ____ and saw many interesting things.", options: ["museum", "passport", "picnic", "practice"], answer: 0 },
      { type: "fill", q: "She always feels n____ before she takes an exam. (紧张的)", answer: "nervous" },
      { type: "choose", q: "Don't forget to bring your ____ when you travel to another country.", options: ["passport", "picnic", "practice", "patient"], answer: 0 },
      { type: "fill", q: "We had a p____ in the park last Sunday. (野餐)", answer: "picnic" },
      { type: "choose", q: "Basketball is a very ____ sport in our school.", options: ["patient", "pleasant", "popular", "nervous"], answer: 2 },
    ]
  },
  ...
  // Day 6
  {
    ...
    title: "Day 6 词汇真题",
    questions: [
      { type: "fill", q: "I got a beautiful p____ from my best friend. (礼物)", answer: "present" },
      { type: "choose", q: "Can you help me solve this maths ____?", options: ["project", "problem", "recipe", "schedule"], answer: 1 },
      { type: "choose", q: "____ to bring your homework to school tomorrow.", options: ["Remember", "Repair", "Decide", "Invite"], answer: 0 },
      { type: "fill", q: "We had dinner at an Italian r____ last night. (餐厅)", answer: "restaurant" },
      { type: "choose", q: "I made a ____ for lunch with bread, cheese and tomato.", options: ["schedule", "recipe", "sandwich", "present"], answer: 2 },
    ]
  },
  ...
  // Day 7
  {
    ...
    title: "Day 7 词汇真题",
    questions: [
      { type: "fill", q: "Please don't tell anyone. It's a s____. (秘密)", answer: "secret" },
      { type: "choose", q: "Playing the piano is a useful ____ for children to learn.", options: ["skill", "stadium", "station", "subject"], answer: 0 },
      { type: "choose", q: "The football match is at the ____ this Saturday.", options: ["station", "stadium", "secret", "subject"], answer: 1 },
      { type: "fill", q: "Go s____ ahead and you will see the post office on your left. (直的)", answer: "straight" },
      { type: "choose", q: "Maths is my favourite ____ at school.", options: ["skill", "snowman", "subject", "stadium"], answer: 2 },
    ]
  },
  ...
  // Day 8
  {
    ...
    title: "Day 8 词汇真题",
    questions: [
      { type: "choose", q: "It's a beautiful ____ day. Let's go to the park.", options: ["sunny", "terrible", "traditional", "useful"], answer: 0 },
      { type: "fill", q: "What a nice s____! I didn't know you were coming. (惊喜)", answer: "surprise" },
      { type: "choose", q: "I go ____ at the sports centre every Tuesday.", options: ["swimming", "shopping", "running", "dancing"], answer: 0 },
      { type: "fill", q: "I bought two t____ for the concert tonight. (票)", answer: "tickets" },
      { type: "choose", q: "It looks like rain. You should take a(n) ____.", options: ["umbrella", "ticket", "surprise", "sandwich"], answer: 0 },
    ]
  },
  ...
  // Day 9
  {
    ...
    title: "Day 9 词汇真题",
    questions: [
      { type: "fill", q: "We are planning a trip for our summer v____. (假期)", answer: "vacation" },
      { type: "choose", q: "The ____ is lovely today. Let's go for a walk.", options: ["weather", "weekend", "visitor", "vegetable"], answer: 0 },
      { type: "choose", q: "We had a ____ time at the party last night.", options: ["worried", "wonderful", "terrible", "boring"], answer: 1 },
      { type: "fill", q: "She is w____ about her exam results. (担心的)", answer: "worried" },
      { type: "choose", q: "I want to ____ my English, so I read books every day.", options: ["imagine", "improve", "invite", "decide"], answer: 1 },
    ]
  },
  ...
  // Day 10
  {
    ...
    title: "Day 10 词汇真题",
    questions: [
      { type: "fill", q: "Swimming is my favourite outdoor a____. (活动)", answer: "activity" },
      { type: "choose", q: "I have an ____ with the dentist at three o'clock.", options: ["appointment", "activity", "available", "airport"], answer: 0 },
      { type: "choose", q: "Are there any tickets ____ for Friday's show?", options: ["available", "biscuit", "bridge", "business"], answer: 0 },
      { type: "fill", q: "She grows flowers on her b____. (阳台)", answer: "balcony" },
      { type: "choose", q: "We walked across the ____ to get to the other side of the river.", options: ["bridge", "business", "blanket", "biscuit"], answer: 0 },
    ]
  },
  ...
  // Day 11
  {
    ...
    title: "Day 11 词汇真题",
    questions: [
      { type: "fill", q: "Our football c____ trains us every afternoon. (教练)", answer: "coach" },
      { type: "choose", q: "She won first prize in the singing ____.", options: ["concert", "competition", "conversation", "collection"], answer: 1 },
      { type: "choose", q: "We went to a ____ last night to listen to some music.", options: ["concert", "circle", "coach", "coast"], answer: 0 },
      { type: "fill", q: "We had a long c____ about our holiday plans. (对话)", answer: "conversation" },
      { type: "choose", q: "We ____ the classroom with balloons for the party.", options: ["decorate", "collect", "compete", "circle"], answer: 0 },
    ]
  },
  ...
  // Day 12
  {
    ...
    title: "Day 12 词汇真题",
    questions: [
      { type: "fill", q: "My father is an e____. He designs bridges. (工程师)", answer: "engineer" },
      { type: "choose", q: "Doing ____ every morning keeps you healthy.", options: ["exercise", "envelope", "factory", "festival"], answer: 0 },
      { type: "choose", q: "My uncle works in a car ____. He makes cars.", options: ["factory", "forest", "fireplace", "festival"], answer: 0 },
      { type: "fill", q: "Spring F____ is the most important holiday in China. (节日)", answer: "Festival" },
      { type: "choose", q: "The ____ is full of tall trees and wild animals.", options: ["forest", "factory", "fireplace", "generation"], answer: 0 },
    ]
  },
  ...
  // Day 13
  {
    ...
    title: "Day 13 词汇真题",
    questions: [
      { type: "fill", q: "I am g____ to see you again after so long! (高兴的)", answer: "glad" },
      { type: "choose", q: "Eating fruit and vegetables keeps you ____.", options: ["healthy", "golden", "honest", "glad"], answer: 0 },
      { type: "choose", q: "The tour ____ showed us around the old castle.", options: ["guide", "ground", "king", "gold"], answer: 0 },
      { type: "fill", q: "Mom is cooking dinner in the k____. (厨房)", answer: "kitchen" },
      { type: "choose", q: "We took a boat to a small ____ for our holiday.", options: ["island", "kitchen", "king", "guide"], answer: 0 },
    ]
  },
  ...
  // Day 14
  {
    ...
    title: "Day 14 词汇真题",
    questions: [
      { type: "fill", q: "This coffee m____ is broken. Can you fix it? (机器)", answer: "machine" },
      { type: "choose", q: "The ____ of our company is very kind to the workers.", options: ["manager", "middle", "monkey", "machine"], answer: 0 },
      { type: "choose", q: "This street is too ____ for two cars to pass.", options: ["narrow", "outside", "ocean", "middle"], answer: 0 },
      { type: "fill", q: "The boat sailed across the deep blue o____. (海洋)", answer: "ocean" },
      { type: "choose", q: "The children are playing ____ in the garden.", options: ["outside", "narrow", "middle", "ocean"], answer: 0 },
    ]
  },
  ...
  // Day 15
  {
    ...
    title: "Day 15 词汇真题",
    questions: [
      { type: "fill", q: "Children love playing on the p____ during break time. (操场)", answer: "playground" },
      { type: "choose", q: "We should ____ the environment by using less plastic.", options: ["protect", "realize", "recommend", "practise"], answer: 0 },
      { type: "fill", q: "He finished the test q____ and was the first to leave. (快速地)", answer: "quickly" },
      { type: "choose", q: "Can you ____ a good restaurant near here?", options: ["recommend", "protect", "realize", "decorate"], answer: 0 },
      { type: "choose", q: "She works as a ____ at the hospital, helping patients for free.", options: ["volunteer", "treasure", "pianist", "manager"], answer: 0 },
    ]
  },
];
...
if (typeof window !== 'undefined') {
  ...
  window.KET_WORD_QUESTIONS = KET_WORD_QUESTIONS;
}