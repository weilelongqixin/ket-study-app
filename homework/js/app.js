...
(function() {
  ...
  var BUILT_IN_ANSWERS = {
    ...
    // ===== 收心自测（第36-40天）=====
    'chinese_36': [
      '字义自测 1.A 2.B 3.D 4.C 5.B 6.B',
      '7.(1)A (2)B (3)A (4)A',
      '8.(1)× (2)× (3)√ (4)×',
      '9.示例：(1)素不相识 (2)素质 (3)素服 (4)素食'
    ],
    'chinese_37': [
      '词语自测 1.(1)纹丝不动 (2)叹为观止 (3)小心翼翼',
      '2.(1)√ (2)√ (3)×',
      '3. B',
      '4.(1)精密 (2)精巧 (3)精致 (4)可贵 (5)高贵 (6)昂贵',
      '5.示例：知解依命有味南北情意估量珍宝提论于尽'
    ],
    'chinese_38': [
      '必背自测(一) 1.示儿：死去元知万事空，但悲不见九州同。王师北定中原日，家祭无忘告乃翁。',
      '2. B 3. B',
      '4.(1)学而不厌 诲人不倦'
    ],
    'chinese_39': [
      '必背自测(二) 1.春眠不觉晓 处处闻啼鸟 夜来风雨声 花落知多少',
      '   月落乌啼霜满天 江枫渔火对愁眠 姑苏城外寒山寺 夜半钟声到客船',
      '2. C 3. C',
      '4.(1)知之为知之 不知为不知 (2)但悲不见九州同',
      '(3)美哉我少年中国与天不老 壮哉我中国少年与国无疆',
      '(4)桃花流水鳜鱼肥 青箬笠绿蓑衣 斜风细雨不须归',
      '(5)家家乞巧望秋月 穿尽红丝几万条'
    ],
    'chinese_40': [
      '综合自测(一) 1.隆重 典礼 诸侯 广阔 体面',
      '2. C 3. A 4. AD',
      '5.(1)① (2)② (3)③',
      '6. 2 3 1 4',
      '7.(1)× (2)× (3)√'
    ...
    'chinese_41': [
      '综合自测(二) 1.地区 混乱 惊慌失措 避难 实际 损失',
      '2.(1)A (2)B (3)D 3.B 4.B 5.A',
      '6.(1)环绕 (2)围绕 (3)模仿 (4)仿照',
      '7.示例：恐万千万职守不可举世星月亭楼诗情观止天地眉眼相依；(1)忠于职守 (2)叹为观止 (3)举世闻名',
      '8.(1)不在他人全在我少年 (2)其道大光一泻汪洋 (3)少年中国中国少年 (4)牽牛织女渡河桥家家乞巧望秋月',
      '9.(1)①太阳形成过程 ②对太阳消亡后人类发展的畅想 (2)B (3)A (4)①打比方 ②列数字 ③列数字作比较 ④列数字',
      '9.(5)打比方说明星云收缩速度快过程剧烈，生动形象'
    ],
    'chinese_42': [
      '综合自测(三) 1.(1)湘菜 粤菜 (2)瑞雪 飘落 寻常 粉妆玉砌',
      '2.(1)沙 纱 (2)燥 噪 (3)仰 抑 (4)稼 嫁',
      '3. D 4. A 5. B',
      '6.(1)平稳 (2)安稳 (3)怂恿 (4)鼓励',
      '7.西塞山前白鹭飞 桃花流水鳜鱼肥 月落乌啼霜满天 天街小雨润如酥',
      '8.(1)D (2)①云缠雾绕 ②山如海奔雾如浪涌 ③雾已极淡 (3)B',
      '(4)①比喻游在海市蜃楼之境 ②比喻雾中橙黄红绿的树木如珊瑚 赞美之情',
      '(5)雾灵山秋日雾海翻涌山林各呈其色，珍惜美景+震撼+对生命伟大的赞叹'
    ],
